...
<template>
        ...
        <ul class="list-disc ml-6 mb-4">
            ...
            <li>Consider the main research disciplines covered by the Service - at least one is required. There is a big drop-down list but you can also see the current full list at <a href="https://hdl.handle.net/21.11158/0002-9dc3-7d05-b211?urlappend=%26simple" target="_blank" class="underlined">here</a>. The list is quite long but additional or narrower disciplines can also be added. These are intended to define general areas of research rather than specific activities. The following two fields will help cover that.</li>
